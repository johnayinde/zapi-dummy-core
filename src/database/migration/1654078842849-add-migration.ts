...
export class addMigration1654078842849 implements MigrationInterface {
  name = 'addMigration1654078842849';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "api" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdOn" TIMESTAMP NOT NULL DEFAULT now(), "createdBy" character varying, "updatedOn" TIMESTAMP, "updatedBy" character varying, "deletedOn" TIMESTAMP WITH TIME ZONE, "deletedBy" character varying, "api_name" character varying NOT NULL, "description" character varying NOT NULL, "type" character varying NOT NULL, "base_url" character varying NOT NULL, "category_id" character varying NOT NULL, "subscribers" character varying, "popularity" integer DEFAULT '0', "about" character varying, "verified" character varying NOT NULL DEFAULT false, "rating" integer DEFAULT '0', "tutorialsId" uuid, "profileId" uuid, CONSTRAINT "UQ_fc7dbce3f828c6b5954f5177715" UNIQUE ("api_name"), CONSTRAINT "REL_a97d009aa61e38179387196950" UNIQUE ("profileId"), CONSTRAINT "PK_12f6cbe9e79197c2bf4c79c009d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(

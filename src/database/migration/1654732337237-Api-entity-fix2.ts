...
export class ApiEntityFix21654732337237 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "api" ADD "status" "public"."api_status_enum" NOT NULL DEFAULT 'unverified'`,
    );
    await queryRunner.query(
      `ALTER TABLE "api" ADD "endpointsId" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "api" ADD "discussionsId" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "api" ADD "priceGroupId" character varying`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."api_type_enum" AS ENUM('public', 'private')`,
    );
    await queryRunner.query(
      `ALTER TABLE "api" ADD "type" "public"."api_type_enum" NOT NULL DEFAULT 'public'`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "api" ADD "type" character varying NOT NULL DEFAULT 'private'`,
    );
    await queryRunner.query(

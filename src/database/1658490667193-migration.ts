...
export class migration1658490667193 implements MigrationInterface {
    name = 'migration1658490667193'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "api" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdOn" TIMESTAMP NOT NULL DEFAULT now(), "createdBy" character varying, "updatedOn" TIMESTAMP, "updatedBy" character varying, "deletedOn" TIMESTAMP WITH TIME ZONE, "deletedBy" character varying, "name" character varying NOT NULL, "description" character varying NOT NULL, "base_url" character varying NOT NULL, "popularity" integer NOT NULL DEFAULT '0', "about" character varying, "subscriptions" text array DEFAULT '{}', "status" "public"."api_status_enum" NOT NULL DEFAULT 'unverified', "visibility" "public"."api_visibility_enum" NOT NULL DEFAULT 'private', "rating" integer NOT NULL DEFAULT '0', "service_level" integer NOT NULL DEFAULT '0', "latency" integer NOT NULL DEFAULT '0', "categoryId" uuid NOT NULL, "profileId" uuid NOT NULL, "secretKey" character varying NOT NULL, "tutorialsId" character varying, "discussionsId" character varying, "priceGroupId" character varying, CONSTRAINT "UQ_8ce91749da904c1cb16bb4e06c1" UNIQUE ("name"), CONSTRAINT "PK_12f6cbe9e79197c2bf4c79c009d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."endpoint_method_enum" AS ENUM('get', 'post', 'put', 'patch', 'delete')`);
        await queryRunner.query(`CREATE TABLE "endpoint" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdOn" TIMESTAMP NOT NULL DEFAULT now(), "createdBy" character varying, "updatedOn" TIMESTAMP, "updatedBy" character varying, "deletedOn" TIMESTAMP WITH TIME ZONE, "deletedBy" character varying, "name" character varying NOT NULL, "method" "public"."endpoint_method_enum" DEFAULT 'get', "route" character varying NOT NULL, "apiId" character varying NOT NULL, "description" character varying NOT NULL, "headers" text array, "requestBody" jsonb array DEFAULT '[]', CONSTRAINT "PK_7785c5c2cf24e6ab3abb7a2e89f" PRIMARY KEY ("id"))`);
